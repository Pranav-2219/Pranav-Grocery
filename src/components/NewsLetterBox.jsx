...
const NewsLetterBox = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    const serviceID = 'service_n60g10b'; // Replace with your EmailJS service ID
    const templateID = 'template_746hvs5'; // Replace with your EmailJS template ID
    const userID = 'NDEk3067b0X58N2bC'; // Replace with your EmailJS user ID
